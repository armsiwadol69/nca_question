...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js?v=<?php echo $version; ?>" integrity="sha512-XMVd28F1oH/O71fzwBnV7HucLxVwtxf26XV8P4wPk26EDxuGZ91N8bsOttmnomcCD3CS5ZMRL50H0GgOHvegtg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdn.datatables.net/buttons/2.4.2/js/buttons.bootstrap5.min.js?v=<?php echo $version; ?>"></script>
<script src="https://cdn.datatables.net/buttons/2.4.2/js/buttons.html5.min.js?v=<?php echo $version; ?>"></script>
<script src="https://cdn.datatables.net/buttons/2.4.2/js/buttons.print.min.js?v=<?php echo $version; ?>"></script>
