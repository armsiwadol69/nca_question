...
<div class="row">
    ...
    <div class="col-12">
        <div class="table-responsive w-100 p-1">
            <table id="list_questionmode" class="table table-bordered table-striped shadow-sm w-100">
...
<div class="modal fade" id="modalquestionmode" tabindex="-1" aria-labelledby="createBatch" aria-hidden="true" >
                ...
                <div class="modal-body">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control" type="text" name="questionmode_name" id="questionmode_name" required>
                        </div>

                        <div class="col-12">
                            <textarea class="form-control" id="questionmode_description" name="questionmode_description" rows="5" required=""></textarea>
                            
                            <input type="hidden" name="questionmode" id="questionmode" value="">
...
<script>
    ...
    async function getquestioncategroup() {
        try {
            var endpoint = `../phpfunc/questionmode.php?method=getlist`;
    ...
    async function initListTable() {
        ListTable = $("#list_questionmode").DataTable({
            stateSave: false,
            ...
            [
                ...
                {
                    data: "questionmode_description",
                    render: function (data, type, row, meta) {
                        return `${data}`;
                    },
                },
                {
                    data: "questionmode_recname",
                    render: function (data, type, row, meta) {
                        return `${data}`;
                    },
                },
                {
                    data: "questionmode_recdatetime",
    ...
    function callQuestionMode(mode,id,name){

        if(mode == "editquestionemode"){
            var actionUrl =  `../phpfunc/questionmode.php`;
            $.ajax({
                type: "POST",
                url: actionUrl,
                data: {
                    method: "getlistquestionmode",
                    questionmode : id,
                },
                dataType: "JSON",
                /*  beforeSend: function(){
                ...
                {   
                    ...
                    if(obj.length > 0){
                        ...
                        $("#questionmode_name").val(res.questionmode_name);
                        $("#questionmode_description").val(res.questionmode_description);
                        $("#questionmode").val(res.questionmode);
                        $("#method").val(mode);
                    } 
                }
            });

            $("#modalquestionmode").modal("show");

        }else if(mode == "addquestionemode"){

            
            $("#questionmode_name").val("");
            $("#questionmode_description").val("");
            $("#questionmode").val("");
            $("#method").val(mode);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed == true) {
                    ...
                    if(id > 0){
                        ...
                        let urlendpoint = `../phpfunc/questionmode.php`;
                        $.ajax({
                            url: urlendpoint,
                            type: "POST",
                            dataType: "JSON",
                            data: {
                                method : 'deletequestionmode',
                                questionmode : id,
                            },
