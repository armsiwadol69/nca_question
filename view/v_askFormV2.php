...
$ar_qid = explode(",",$_GET['id']);

echo "<pre>";
// print_r(array_filter($ar_qid));
echo "</pre>";
            ...
            <div class="col-12">
                <form class="needs-validation" action="../class/apiQuestion.php?method=saveAnswer" method="POST" id="mForm" enctype="multipart/form-data">
                    <div class="row mb-5">
                        ...
                        <div class="col-12 text-center">
                            <h1>แบบฟอร์มเก็บสถิติ</h1>
                            <h4>แผนกเทคโนโลยีสารสนเทศ</h4>
                        </div>
                    </div>
                    <?
                        $isFirst = true;
                        foreach ($ar_qid as $kk => $vv) {
                            $ncaquestion = new questionview($vv);
                            $questioninfo = array();
                            ...
                            echo "<h2 class=\"fw-bold\">$formName</h2>";
